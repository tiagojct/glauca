#!/usr/bin/env python3
"""Machado-2009 colour-vision-deficiency pass for Glauca. No dependencies.
Reports deltaE between key hue pairs under protan/deutan/tritan at full severity."""
import json, math, pathlib
D = json.loads((pathlib.Path(__file__).resolve().parent.parent / "glauca.json").read_text())
...
keys=list(hues)
print("Glauca CVD pass (deltaE; <10 reinforced with weight/italics)")
for kind in M:
